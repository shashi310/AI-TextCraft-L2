...
const handleClick=()=>{
  ...
  axios.post('http://localhost:5000/text/emotion', requestBody, {
  headers: {
...
return (
    ...
    <Navbar />
        <Flex>
          ...
          <Spacer />
    <Box border='2px' borderColor='gray.400' w="64%" h="100vh" pl="5%" /* bgColor="bisque" */>
          
          <Flex mt="2%" className='main' textAlign="center" ml="15%">
           ...
           <Button width="40%" colorScheme='green' onClick={handleClick}>Detect Emotion</Button>
          </Flex>
